const en = {
    ...
    onlyImageMsg: 'Only image files can be inserted',
    imageTooLargeMsg: 'Image is too large, please keep it under 5MB',
    ...
    month: ' months',
    day: ' days',
    emailMaintenance: 'Email Maintenance',
    syncDelete: 'Hard Delete',
    syncDeleteDesc: 'When enabled, deleting an email removes it physically (no soft delete) along with its attachments',
    autoCleanEmail: 'Auto Clean Emails',
    autoCleanEmailDesc: 'Physically delete emails older than the retention days every day. 0 disables cleaning',
    autoCleanExclude: 'Clean Exclusion List',
    autoCleanExcludeHint: 'Emails of these user accounts are excluded from auto cleaning. Press Enter to add',
    autoCleanExcludePlaceholder: 'Enter a user email and press Enter',
    aiCode: 'Code Extraction',
    aiCodeDesc: 'Workers AI extracts verification codes from incoming mail and shows a copy chip in the list and detail view. Regex is only used if the model fails or is not bound. The free 10,000 Neurons/day quota is enough for this short task. No API key required.',
    aiCodeEnable: 'Enable extraction',
    aiCodeEnableDesc: 'Turn off to stop extracting codes. Only applies to mail received after enabling; existing mail is not backfilled',
    workersAi: 'Workers AI',
    workersAiDesc: 'Bind [ai] in wrangler.toml to use Cloudflare Workers AI. Regex still runs if the binding is missing',
    workersAiBound: 'Bound',
    workersAiUnbound: 'Not bound',
    aiModel: 'Model',
    aiModelDesc: 'Only text models suitable for inbound mail are listed. Larger models are more accurate and use more of the free quota',
    aiModelTagRecommend: 'Recommended',
    aiModelTagLowCost: 'Lowest cost',
    aiModelTagZh: 'Better Chinese',
    aiModelTagStrong: 'Stronger, uses more quota',
    aiCodeFilter: 'Code Extraction List',
    aiCodeFilterHint: 'Only extract codes from these senders or domains. Leave empty to extract from all. Press Enter to add',
    aiCodeFilterPlaceholder: 'Enter a sender email or domain and press Enter',
    newEmailNotify: 'New Email Notification',
    newEmailNotifyDesc: 'Show a popup when new email arrives. Uses browser system notifications when the page is in background',
    neverLogin: 'Never',
